        ...
        <div className="card p-8 mb-8">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 mb-8">
            ...
            <div className="text-gray-700 space-y-3">
              <p>
                This CMMC Gap Analysis Tool provides comprehensive cybersecurity maturity assessments 
                for organizations seeking compliance with Department of Defense requirements.
              </p>
              <p>
              ...
              <p>
                <strong>Generated Reports:</strong> Upon completion, this tool generates five comprehensive report types:
              </p>
              <ul className="ml-6 space-y-1 text-sm">
                <li><strong>Executive Summary Report</strong> - High-level compliance overview for leadership decision-making</li>
                <li><strong>Technical Implementation Report</strong> - Detailed technical findings and remediation guidance for IT teams</li>
                <li><strong>Action Plan Report</strong> - Prioritized homework assignments and implementation roadmap</li>
                <li><strong>Progress Tracking Report</strong> - Compliance scoring and gap analysis with visual dashboards</li>
                <li><strong>Certification Readiness Report</strong> - Assessment of readiness for formal CMMC certification</li>
              </ul>
              <p className="text-sm">
                All reports are available in both PDF and Word formats for easy distribution and collaboration.
              </p>
            </div>
          </div>
